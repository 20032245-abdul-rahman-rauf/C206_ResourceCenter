...
public class ResourceCentreTest { 
 ...
 public void testDoReturnCamcorder() { 
  ...
  //Test that a given list is not null, a newly added item cannot be returned successfully 
    ...
    assertFalse(ResourceCentre.doReturnCamcorder(camcorderList,cb1.getAssetTag())); 
     
    //Test that 3rd camcorder which are loaned already is not available and have a due date 
     
    ResourceCentre.addCamcorder(camcorderList, cc2); 
    ResourceCentre.doLoanCamcorder(camcorderList, "CB0013", "24/8/2021"); 
    ...
    //Test that after 3rd chromebook returned, Avalaible becomes "Yes" and has no due date. 
 ...
 public void testDoReturnChromebook() { 
  ...
  //Test that 3rd chromebook which are loaned already is not available and have a due date 
